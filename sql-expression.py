...
# Create the variable for "Artist" table
artist_table = Table(
    "Artist",
    meta,
...
# Create the variable for "Album" table
album_table = Table(
    "Album",
    meta,
...
with db.connect() as connection:
    ...
    # select_query = artist_table.select(
    #     whereclause=artist_table.c.Name == "Queen",
    # )
    ...
    # Query 3.1 - select matching artists ("Queen" and "AC/DC") from the
    # "Artist" table
    # select_query = artist_table.select().where(
    #     or_(artist_table.c.Name == "Queen", artist_table.c.Name == "AC/DC")
    # )
